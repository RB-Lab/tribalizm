...
const en: BaseTranslation = {
    ...
    rules: {
        apply: {
            text: `To join a tribe you like you must send application. 
		...
		onBrainsotrm: {
			text: `In a brainstorm you will suggest activities for the tribe and vote for activities you like
	...
	tribesList: {
		requestLocationText: 'To find tribes nearby we need acces to your location',
